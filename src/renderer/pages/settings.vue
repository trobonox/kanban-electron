  ...
  <div class="px-6">
    ...
    <main id="settings" class="ml-4 mt-8">
      ...
      <div id="theme-selection" class="flex flex-row gap-4">
        <div
          class="bg-elevation-1 bg-elevation-2-hover flex flex-col items-center justify-center rounded-md w-36 p-2 text-xl font-semibold cursor-pointer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" id="light-mode-icon" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
        ...
        <div
          class="bg-elevation-1 bg-elevation-2-hover flex flex-col items-center justify-center rounded-md w-36 p-2 text-xl font-semibold cursor-pointer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" id="dark-mode-icon" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>
        ...
        <div
          class="bg-elevation-1 bg-elevation-2-hover flex flex-col items-center justify-center rounded-md w-36 p-2 text-xl font-semibold cursor-pointer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" id="custom-mode-icon" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>
